...
import { smartDoorProduct as product } from '../data/storeProducts';

export const SmartDoorProduct: React.FC = () => {
  return (
    <AppShell className="bg-[#f4f7fb] pb-24">
      <SEO
        title="Engineering Smart Door - MakerLab course + kit"
        description="A MakerLab STEM adventure where learners design, simulate, code, assemble, test and customize a smart door project."
        keywords="Smart Door kit, microbit robotics course, STEM kit Morocco, MakerLab CAD project, kids maker kit"
          ...
          <Reveal>
            <div className="max-w-2xl">
              ...
              <h1 className="mt-7 max-w-2xl text-[3.4rem] font-black leading-[0.92] text-[#003c9e] md:text-[5.4rem]">
                Smart Door is a full maker adventure.
              </h1>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link to="/contact?subject=smart-door-workshop" className="ml-button bg-[#e30613] px-6 text-white shadow-lg">
                  Build it at MakerLab <ArrowRight size={19} />
                </Link>
                <Link to="/contact?subject=smart-door-kit" className="ml-button border border-[#c8d8f2] bg-white px-6 text-[#003c9e] shadow-sm">
                  Join kit pilot <ShoppingCart size={19} />
                </Link>
              </div>
          ...
          <Reveal delay={120}>
            <div className="relative">
              <img
                ...
                alt="MakerLab Engineering Smart Door kit with MDF sliding door, micro:bit, servo, ultrasonic sensor and guide"
              ...
              <div className="relative mx-4 -mt-10 rounded-[1rem] border border-[#d8e4f6] bg-white p-4 shadow-xl md:mx-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-black uppercase tracking-[0.14em] text-[#003c9e]">Not an assembly-only kit</p>
                    <p className="mt-1 text-sm font-semibold leading-5 text-slate-600">
                      The product includes the learning path: CAD, circuit simulation, robotics explanation, programming, assembly, testing and customization.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <Reveal>
          <section className="rounded-[1.4rem] border border-[#d8e4f6] bg-white p-6 shadow-xl md:p-8">
            <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.16em] text-[#e30613]">The adventure path</p>
                <h2 className="mt-3 text-4xl font-black leading-tight text-[#003c9e]">From blank idea to smart prototype.</h2>
                <p className="mt-4 text-base font-semibold leading-7 text-slate-600">
                  Parents should see the value immediately: the child learns the full product loop, then uses the kit to prove the work in real life.
                </p>
              </div>
        ...
        <Reveal>
          <section className="grid gap-5 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="overflow-hidden rounded-[1.4rem] border border-[#d8e4f6] bg-white shadow-xl">
              <img src={product.unboxingImage} alt="Smart Door kit unboxing with parts, guide and electronics" className="h-full min-h-[520px] w-full object-cover" />
            </div>
            <div className="rounded-[1.4rem] bg-[#003c9e] p-7 text-white shadow-xl">
              ...
              <h2 className="mt-3 text-4xl font-black leading-tight">A robotics playbook plus real parts.</h2>
          ...
          <section className="rounded-[1.4rem] border border-[#d8e4f6] bg-white p-6 shadow-xl md:p-8">
            <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
              <div>
                ...
                <h2 className="mt-2 text-4xl font-black leading-tight text-[#003c9e]">Every part has a learning job.</h2>
              </div>
              <p className="max-w-lg text-sm font-semibold leading-6 text-slate-500">
                Final supplier, quantity and safety labels still need production approval, but the product story now reflects the real Smart Door system.
              </p>
            </div>
          ...
          <section className="rounded-[1.4rem] bg-[#17242d] p-6 text-white shadow-xl md:p-8">
            <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
              <div>
                ...
                <h2 className="mt-2 text-4xl font-black leading-tight">Start at home, at MakerLab, or with a custom version.</h2>
              </div>
              <p className="max-w-md text-sm font-semibold leading-6 text-white/70">
                We keep checkout controlled until price, age, delivery, safety and stock are confirmed. For now, the store converts into pilot interest and guided booking.
              </p>
            </div>
        ...
        <Reveal>
          <section className="rounded-[1.4rem] border border-[#d8e4f6] bg-white p-6 shadow-xl md:p-8">
            <div className="grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.16em] text-[#003c9e]">Customization loop</p>
                <h2 className="mt-2 text-3xl font-black leading-tight">The kit can become the child’s own version.</h2>
                <p className="mt-4 text-sm font-semibold leading-6 text-slate-500">
                  The store should make this visible: the learner can modify the CAD idea, then MakerLab can help print, laser-cut, or prepare a custom version when the service is available.
                </p>
              </div>
              <div className="grid gap-3 sm:grid-cols-3">
                {[
                  [Upload, 'Upload or bring CAD', 'Share a modified door concept.'],
                  [Users, 'Ask MakerLab support', 'Get help checking the design.'],
                  [Box, 'Print or cut version', 'Fabricate a customized prototype.'],
                ].map(([Icon, title, text]) => {
            ...
            <Link to="/contact?subject=smart-door-custom-cad" className="mt-7 inline-flex items-center gap-2 rounded-lg border border-[#d8e4f6] bg-white px-5 py-3 font-black text-[#003c9e] shadow-sm">
              Request custom fabrication support <Download size={18} />
            </Link>
          </section>
        </Reveal>
      </AppContainer>
